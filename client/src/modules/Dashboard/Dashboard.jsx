                        ...
                        <div className="row">
                            <div className="col-12">
                                <div className="page-title-box d-sm-flex align-items-center justify-content-between bg-transparent">
                                    <h4 className="mb-sm-0">Ecommerce</h4>
                                        ...
                                        <div className="col-xl-8">
                                            <div className="card">
                                                ...
                                                <div className="card-body p-0 pb-2">
                                                    <div className="w-100">
                                                        <div id="customer_impression_charts" data-colors='["--vz-secondary", "--vz-primary", "--vz-primary-rgb, 0.50"]' className="apex-charts" dir="ltr"></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div className="row">
                                        <div className="col-xl-4">
                                            <div className="card card-height-100">
                                                ...
                                                <div className="card-body">
                                                    <div id="store-visits-source" data-colors='["--vz-primary", "--vz-primary-rgb, 0.85", "--vz-primary-rgb, 0.70", "--vz-primary-rgb, 0.60", "--vz-primary-rgb, 0.45"]' className="apex-charts" dir="ltr"></div>
                                                </div>
                                            </div> 
                                        </div> 
                                                    ...
                                                    <div className="table-responsive table-card">
                                                        <table className="table table-borderless table-centered align-middle table-nowrap mb-0">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td>
                                                                        <Link to="apps-ecommerce-order-details.html" className="fw-medium link-primary">#VZ2112</Link>
                                                                    </td>
                                                                    <td>
                                                                        <div className="d-flex align-items-center">
                                                                            <div className="flex-shrink-0 me-2">
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <Link to="apps-ecommerce-order-details.html" className="fw-medium link-primary">#VZ2111</Link>
                                                                    </td>
                                                                    <td>
                                                                        <div className="d-flex align-items-center">
                                                                            <div className="flex-shrink-0 me-2">
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <Link to="apps-ecommerce-order-details.html" className="fw-medium link-primary">#VZ2109</Link>
                                                                    </td>
                                                                    <td>
                                                                        <div className="d-flex align-items-center">
                                                                            <div className="flex-shrink-0 me-2">
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <Link to="apps-ecommerce-order-details.html" className="fw-medium link-primary">#VZ2108</Link>
                                                                    </td>
                                                                    <td>
                                                                        <div className="d-flex align-items-center">
                                                                            <div className="flex-shrink-0 me-2">
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <Link to="apps-ecommerce-order-details.html" className="fw-medium link-primary">#VZ2107</Link>
                                                                    </td>
                                                                    <td>
                                                                        <div className="d-flex align-items-center">
                                                                            <div className="flex-shrink-0 me-2">
                                        ...
                                        <div className="card-body p-0">
                                            ...
                                            <div data-simplebar style={{ maxHeight: "410px"}} className="p-3 pt-0">
                                                <div className="acitivity-timeline acitivity-main">
                                                    ...
                                                    <div className="acitivity-item py-3 d-flex">
                                                        ...
                                                        <div className="flex-grow-1 ms-3">
                                                            <h6 className="mb-1 lh-base">Today offers by <Link to="apps-ecommerce-seller-details.html" className="link-secondary">Digitech Galaxy</Link></h6>
                                            ...
                                            <div className="p-3 mt-2">
                                                ...
                                                <ol className="ps-3 text-muted">
                                                    <li className="py-1">
                                                        <Link to="#" className="text-muted">Mobile & Accessories <span className="float-end">(10,294)</span></Link>
                                                    </li>
                                                    <li className="py-1">
                                                        <Link to="#" className="text-muted">Desktop <span className="float-end">(6,256)</span></Link>
                                                    </li>
                                                    <li className="py-1">
                                                        <Link to="#" className="text-muted">Electronics <span className="float-end">(3,479)</span></Link>
                                                    </li>
                                                    <li className="py-1">
                                                        <Link to="#" className="text-muted">Home & Furniture <span className="float-end">(2,275)</span></Link>
                                                    </li>
                                                    <li className="py-1">
                                                        <Link to="#" className="text-muted">Grocery <span className="float-end">(1,950)</span></Link>
                                                    </li>
                                                    <li className="py-1">
                                                        <Link to="#" className="text-muted">Fashion <span className="float-end">(1,582)</span></Link>
                                                    </li>
                                                    <li className="py-1">
                                                        <Link to="#" className="text-muted">Appliances <span className="float-end">(1,037)</span></Link>
                                                    </li>
                                                    <li className="py-1">
                                                        <Link to="#" className="text-muted">Beauty, Toys & More <span className="float-end">(924)</span></Link>
                                                    </li>
                                                    <li className="py-1">
                                                        <Link to="#" className="text-muted">Food & Drinks <span className="float-end">(701)</span></Link>
                                                    </li>
                                                    <li className="py-1">
                                                        <Link to="#" className="text-muted">Toys & Games <span className="float-end">(239)</span></Link>
                                                    </li>
                                                </ol>
                                                <div className="mt-3 text-center">
                                                    <Link to="#" className="text-muted text-decoration-underline">View all Categories</Link>
                                                </div>
                                            </div>
                                            <div className="p-3">
